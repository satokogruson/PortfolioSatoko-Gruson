    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
        <div className="max-w-3xl">
          ...
          >
            My multi-cultural background and a master's in Translation & Localization Management will help you broaden your target audience! <span className="inline-block hover:rotate-12 transition-transform duration-300">😊</span>
          </motion.p>
